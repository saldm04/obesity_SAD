...
\item \textbf{FCVC} (Continua): frequenza di consumo di verdure durante i pasti.
\item \textbf{NCP} (Continua): numero di pasti principali giornalieri.
...
\item \textbf{CH2O} (Continua): quantità d’acqua consumata quotidianamente.
\item \textbf{SCC} (Binaria): monitoraggio dell’assunzione calorica giornaliera; valori: \emph{yes}, \emph{no}.
\item \textbf{FAF} (Continua): frequenza dell’attività fisica settimanale.
\item \textbf{TUE} (Continua): tempo di utilizzo quotidiano di dispositivi tecnologici.
